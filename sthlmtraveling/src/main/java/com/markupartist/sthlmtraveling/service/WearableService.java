...
/**
 * Created by Joakim af Sandeberg on 2016-11-25.
 */
...
import com.markupartist.sthlmtraveling.data.models.TravelEvent;
...
public class WearableService extends WearableListenerService implements SharedPreferences.OnSharedPreferenceChangeListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        ...
        if (!mGoogleApiClient.isConnected()) {
            ...
            if (path.equals("GETDATA")) {
                ...
                Toast.makeText(getApplicationContext(), "Receiving location!",
                        Toast.LENGTH_LONG).show();
